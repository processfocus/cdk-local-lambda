/**
 * Integration tests for the bridge Lambda handler.
 *
 * These tests verify the bridge handler's SSM integration and message handling.
...
describe("Bridge Handler", () => {
  ...
  describe("SSM Integration", () => {
    it.skipIf(shouldSkip)("reads AppSync endpoints from SSM", async () => {
    ...
    it.skipIf(shouldSkip)("caches SSM parameters", async () => {
    ...
    it.skipIf(shouldSkip)(
      "returns fresh values after cache clear",
      async () => {
        const endpoints1 = await getAppSyncEndpoints()
        clearEndpointCache()
        const endpoints2 = await getAppSyncEndpoints()
  ...
  describe("Handler Invocation", () => {
    it.skipIf(shouldSkip)(
      "sends invocation with correct structure",
      async () => {
    ...
    it.skipIf(shouldSkip)("correlates response by requestId", async () => {
    ...
    it.skipIf(shouldSkip)("returns success result", async () => {
    ...
    it.skipIf(shouldSkip)("throws error for error response", async () => {
    ...
    it.skipIf(shouldSkip)(
      "includes function context in invocation",
      async () => {
